...
<head>
    ...
    <?php if (isDarkTheme()) : ?>
        <link href="<?= staticPath("cdn.jsdelivr.net/npm/bootswatch@4.3.1/dist/darkly/bootstrap.min.css") ?>"
              rel="stylesheet">
        <link href="static/css/darkly/main.css" rel="stylesheet">
        <link href="static/css/darkly/prettify-dark.css" rel="stylesheet">
        <link href="<?= staticPath("cdn.bootcss.com/codemirror/5.48.4/theme/tomorrow-night-bright.css") ?>"
              rel="stylesheet">
    <?php else: ?>
        <link href="<?= staticPath("cdn.bootcss.com/twitter-bootstrap/4.3.1/css/bootstrap.min.css") ?>"
              rel="stylesheet">
    ...
    <script src="//cdn.bootcdn.net/ajax/libs/lunar-javascript/1.2.37/lunar.min.js"></script>
<!--    <script src="//cdn.bootcdn.net/ajax/libs/lunar-javascript/1.6.4/lunar.min.js"></script>-->
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 col-md-3">
                    ...
                    if (isDarkTheme()):
                        ?>
                        <a href="javascript:SetCookie('ISDARK',0);location.reload();" class="btn btn-light btn-xs"
                           style="color: #212529;background-color: #f8f9fa;border-color: #f8f9fa;">白背景</a>
                    <?php
                    else:
                        ?>
                        <a href="javascript:SetCookie('ISDARK',1);location.reload();"
                           class="btn btn-dark btn-xs">黑背景</a>
                    <?php
                    endif;
                    ?>
                </div>
